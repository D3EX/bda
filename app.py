...
# Cache l'encodage base64 de l'image pour éviter de le recalculer à chaque fois
...
# Cache les données de date/heure pour éviter recalcul
@st.cache_data(ttl=1)  # Cache pour 1 seconde (se rafraîchit chaque seconde)
def get_current_datetime():
    current_date = datetime.now().strftime("%d/%m/%Y")
    current_time = datetime.now().strftime("%H:%M")
    return current_date, current_time

# Affiche d'abord un spinner pour montrer que la page se charge
with st.spinner("Chargement de la page d'accueil..."):
    # Créer des placeholders pour tout le contenu
    header_placeholder = st.empty()
    hero_placeholder = st.empty()
    buttons_placeholder = st.empty()
    stats_placeholder = st.empty()
    features_placeholder = st.empty()
    roles_placeholder = st.empty()
    cta_placeholder = st.empty()
    footer_placeholder = st.empty()

# Fonction pour charger et afficher toute la page
def load_full_page():
    current_date, current_time = get_current_datetime()
    base64_image = get_base64_image()
    
    # Ajouter le CSS d'abord
    st.markdown("""
    <style>
    ...
    with hero_placeholder.container():
        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <h1 class="hero-title">
                    📚 Système de Gestion <span>des Examens</span>
                </h1>
                ...
                <div class="hero-buttons">
                    <a class="hero-button-primary">
                        <span>📅 Données fiables et mises à jour </span>
                    </a>
            ...
            <div class="hero-image-container">
                <div class="hero-image" style="background: url('{base64_image}') center/cover no-repeat;"></div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with stats_placeholder.container():
        st.markdown('<h2 class="section-title">📊 Tableau de Bord Global</h2>', unsafe_allow_html=True)
        
        st.markdown("""
        <div class="stats-grid">
            <div class="stat-card-academic">
                <div class="stat-icon-academic">🏛️</div>
    ...
    with features_placeholder.container():
        st.markdown('<h2 class="section-title">✨ Fonctionnalités Avancées</h2>', unsafe_allow_html=True)
    ...
    # Roles Section
    with roles_placeholder.container():
        st.markdown('<h2 class="section-title">👥 Espaces Personnalisés</h2>', unsafe_allow_html=True)
        ...
        with roles_col1:
            ...
            <div class="role-card-academic">
                <div class="role-icon-academic">🔧</div>
        ...
        with roles_col2:
            st.markdown("""
            <div class="role-card-academic">
                <div class="role-icon-academic">🎖️</div>
...
# Charger toute la page en une fois
load_full_page()
